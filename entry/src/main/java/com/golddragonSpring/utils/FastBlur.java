...
public class FastBlur {
    ...
    public static PixelMap doBlur(PixelMap sentBitmap, int radius, boolean canReuseInBitmap) {
        ...
        if (canReuseInBitmap) {
            ...
            initializationOptions.alphaType =sentBitmap.getImageInfo().alphaType;
            initializationOptions.pixelFormat=sentBitmap.getImageInfo().pixelFormat;
            initializationOptions.size=sentBitmap.getImageInfo().size;
            bitmap = PixelMap.create(sentBitmap,initializationOptions);
        }
